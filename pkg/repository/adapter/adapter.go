...
type Interface interface {
	...
	FindAllUsingQuery(condition expression.Expression, tableName string, indexName string, keyName string, keyValue string) (response *dynamodb.QueryOutput, err error)
...
func (db *Database) FindAllUsingQuery(condition expression.Expression, tableName string, indexName string, keyName string, keyValue string) (response *dynamodb.QueryOutput, err error) {
	...
	return db.connection.Query(input)
