...
import (
	...
	SecurityScoreCardService "riscvue.com/pkg/services/securityScoreCard"
...
type Handler struct {
	...
	Service    services.SecurityScoreCardInterface
}

func NewHandler(repository adapter.Interface, req *http.Request) handlers.Interface {
	return &Handler{
		Req:     req,
		Service: SecurityScoreCardService.NewSecurityScoreCardService(repository),
